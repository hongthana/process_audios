...
parser.add_argument("--target_dir", type=str, default="", help="# of audios to split.")
parser.add_argument("--output_dir", type=str, default="", help="# path t result")
                    ...
                    if fname[-3:] == "wav":
                        ...
                        if duration > 30:
                            ...
                            segments = vad_collector(
                                sample_rate, 30, padding_duration, vad, frames
                            )
                            for i, segment in enumerate(segments):
                                path = (
                                    args.output_dir
