...
if __name__ == "__main__":
    ...
    parser.add_argument("--src", default="/home/psc/Desktop/code/asr/data/LibriSpeech/audio/LibriSpeech", help="source directory")
    parser.add_argument("--dst", help="destination directory", default="./librispeech")
    args = parser.parse_args()

    assert os.path.isdir(str(args.src)), "Librispeech src directory not found - '{d}'".format(d=args.src)
