...
dir_path = "/home/psc/Desktop/code/asr/data/wav2vec/src_downloads/talkShow"
...
for fname in glob.iglob(search_path, recursive=True):
    ...
    audio_save_path = os.path.join(save_dir, os.path.basename(fname).replace(".webm", ".wav"))
    ...
    cur_split_dir = os.path.join(save_dir, os.path.basename(fname).replace(".webm", ""))
